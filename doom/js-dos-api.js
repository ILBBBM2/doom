...
(function() {
  this.Dosbox = (function() {
    ...
    Dosbox.prototype.downloadScript = function() {
      this.module.setStatus('downlopad js-dos');
      this.ui.updateMessage('downlaod js-dos');
      return new Dosbox.Xhr('https://ilbbbm2.github.io/html-games/js-dos.js', {
        success: (function(_this) {
          return function(script) {
            var func;
            _this.ui.updateMessage('init dosbox');
            func = function() {
        ...
        progress: (function(_this) {
          return function(total, current) {
            return _this.ui.updateMessage("download js-dos (" + (current * 100 / total | 0) + "%)");
          };
        })(this)
      });
    };
